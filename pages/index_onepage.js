            ...
            <div className='vertical-center'>
              <div className='started-content'>
                <h1 className='h-title'>
                  👋 Hello, I&apos;m <strong>Lindsey Howard</strong>,
              ...
              <div className='col col-md'>
                ...
                <div className='resume-items'>
                  ...
                  <div className='resume-item content-box'>
                    ...
                    <div className='text'>
                      Empower your business's growth with an experienced sales
                      and marketing manager who drives results and maximizes
                ...
                <div className='resume-items'>
                  ...
                  <div className='resume-item content-box'>
                    ...
                    <div className='text'>
                      ...
                      <br />• Designed mobile-first full-stack applications from
